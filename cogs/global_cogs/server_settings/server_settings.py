...
class server_settings(commands.Cog):
    ...
    async def edit_server_settings(self, interaction):
        ...
        #get language file
        language_file = await language.select_language(server_language, "commands\settings\settings_messages.json")
    ...
    async def language_settings(self, language_file, interaction, message, settings):
        ...
        #update the server language setting
            ...
            #update the server language setting
            await self.update_server_settings(interaction.guild_id, "language", f"\'{language_dropdown.selection}\'")
            ...
            await self.display_settings_page(language_file, interaction, message, settings, language_dropdown.page)
            return
