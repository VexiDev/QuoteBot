    ...
    async def addusers(self, ctx):
        ...
        try:
            ...
            for guild in self.bot.guilds:
                ...
                if guild.id in [924190330604113980, 888091775347089479, 908428900697272360, 869428791041220618,903917888572882954, 836500033485930508,830218584424579102,913109336694333502,476157756190228521,810318689584545863]:
